<div class="modal fade" id="verifyEmailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog email-modify">
        <div class="modal-content">
            <div class="modal-header email-modify-header">
                <button type="button" class="close email-modify-close" data-dismiss="modal" aria-hidden="true">×
                </button>
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group new-email">
                            ...
                            <div class="col-sm-7 extra">
                                <input type="text" id="old-email" name="old-email" class="form-control text-extra"
                ...
                <div class="row">
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group new-email">
                            ...
                            <div class="col-sm-7 extra">
                                <input type="text" id="new-email" name="new-email" class="form-control text-extra"
                                       placeholder="请输入更换邮箱地址">
                            </div>
                        </div>
