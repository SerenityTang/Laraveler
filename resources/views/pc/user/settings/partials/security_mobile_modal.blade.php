<div class="modal fade" id="verifyMobileModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog mobile-modify">
        <div class="modal-content">
            <div class="modal-header mobile-modify-header">
                <button type="button" class="close mobile-modify-close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div class="modal-body mobile-modify-body">
                <div class="row">
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" {{--action="{{ url('/user/verify_mobile') }}"--}}>
                        <p class="mobile-icon">
                        ...
                        <div class="form-group old-mobile">
                            ...
                            <div class="col-sm-7 extra">
                                <input type="text" id="old-mobile" name="old-mobile" class="form-control text-extra" placeholder="请输入原手机号码">
                            </div>
                        </div>
...
<div class="modal fade" id="mobileModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog mobile-modify">
        <div class="modal-content">
            ...
            <div class="modal-body mobile-modify-body">
                <div class="row">
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" {{--action="{{ url('/user/mobile_bind') }}"--}}>
                        <p class="mobile-icon">
                        ...
                        <div class="form-group new-mobile">
                            ...
                            <div class="col-sm-7 extra">
                                <input type="text" id="new-mobile" name="new-mobile" class="form-control text-extra" placeholder="请输入新手机号码">
                            </div>
                        </div>
