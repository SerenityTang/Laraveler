            ...
            <div class="col-md-9">
                <div class="panel panel-default right-container">
                    ...
                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data"
                          action="{{ url('user/auth/profile/per_detail') }}">
                        <input type="hidden" id="editor_token" name="_token" value="{{ csrf_token() }}"/>
                        <input type="hidden" id="avatar_image" name="avatar_image"
                               value="{{ \Illuminate\Support\Facades\Cookie::get('avatar_image') }} "/>
                        <p class="small-title">基本信息</p>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">头像</label>
                            <div class="col-sm-8">
                                <img class="avatar-46 avatar-img" id="user_avatar_image" name="user_avatar_image"
                                     src="{{ \App\Helpers\Helpers::get_user_avatar(Auth()->user()->id,'medium') }}"
                                     alt="头像">
                                <div class="wu-example">
                                    <div class="change-avatar">
                                        <button type="button" class="btn avatar-btn" data-toggle="modal"
                                                data-target="#avatar_modal">修改头像
                                        </button>
                                        ...
                                        <div class="modal fade" id="avatar_modal" tabindex="-1" role="dialog"
                                             aria-labelledby="avatar_model_label">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-6 text-center">
                                                                <div id="avatar_origin" class="avatar-container">
                                                                    <img class="avatar-origin"
                                                                         src="{{ \App\Helpers\Helpers::get_user_avatar(Auth()->user()->id,'origin') }}">
                                                                </div>
                                                                <!--用来存放文件信息-->
                                                                <div id="uploader">
                                                                    <div id="fileList" class="uploader-list"></div>
                                                                    <div id="filePicker" class="picker-container">选择图片
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-6 text-center mt-5">
                                                                ...
                                                                <button id="avatar_btn" type="button"
                                                                        class="btn btn-primary avatar_btn">保存头像
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-extra" id="username" name="username"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-extra" id="realname" name="realname"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="birthday" name="birthday" value="{{ $user->birthday }}"
                                       class="form-control text-extra required" style="width: 275px;"
                                       placeholder="请选择生日时间">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="city-picker" name="city-picker"
                                       class="form-control text-extra required city-bg" placeholder="省 / 市 "
                                       data-toggle="city-picker" data-level="city">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">个性域名</label>
                            <div class="col-sm-8">
                                <input type="text" id="personal_domain" name="personal_domain"
                                       value="{{ $user->personal_domain }}" class="form-control text-extra"
                                       placeholder="默认前缀 http://serenity.cn/user/">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">个人网站</label>
                            <div class="col-sm-8">
                                <input type="text" id="personal_website" name="personal_website"
                                       value="{{ $user->personal_website }}" class="form-control text-extra"
                                       placeholder="默认前缀 http://">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="description" name="description" class="form-control"
                                          placeholder="请简单介绍一下自己吧^_^" rows="3">{{ $user->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">微信二维码</label>
                            <div class="col-sm-6">
                                <input type="file" class="filestyle" accept="image/*" id="wechat_qrcode"
                                       name="wechat_qrcode" value="{{ $user->wechat_qrcode }}" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 career_status">
                                ...
                                <ul class="dowebok">
                                    {{--<p>请选择您当前的职业状态：</p>--}}
                                    <li><input type="radio" id="stu" name="career_status" value="0" data-labelauty="学生"
                                               @if($user->career_status == 0) checked @endif></li>
                                    <li><input type="radio" id="working" name="career_status" value="1"
                                               data-labelauty="在职" @if($user->career_status == 1) checked @endif></li>
                                    <li><input type="radio" id="wait_employ" name="career_status" value="2"
                                               data-labelauty="待业" @if($user->career_status == 2) checked @endif></li>
                                </ul>
                            </div>
                        </div>
                        <div class="form-group">
