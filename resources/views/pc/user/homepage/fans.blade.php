        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default right-container">
                    <h4 class="title">@if($user->id != (Auth::check() ? Auth::user()->id : 0)) TA的粉丝 @else
                            我的粉丝 @endif</h4>
                            ...
                            @foreach($fans as $fan)
                                <li class="list-group-item list-">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <a class="att-u-name"
                                               href="{{ url('user/'.\App\Helpers\Helpers::get_user($fan->user_id)->personal_domain) }}">
                                                <img src="{{ App\Helpers\Helpers::get_user_avatar($fan->user_id, 'medium') }}"
                                                     class="avatar-46"
                                                     alt="{{ \App\Helpers\Helpers::get_user($fan->user_id)->username }}">
                                            </a>
                                        </div>
                                        <div class="col-md-8">
                                            <a class="att-u-name"
                                               href="{{ url('user/'.\App\Helpers\Helpers::get_user($fan->user_id)->personal_domain) }}">{{ \App\Helpers\Helpers::get_user($fan->user_id)->username }}</a>
                                            <p class="data">
                                        ...
                                        <div class="col-md-1 col-md-offset-2">
                                            <a class="attention-icon" style="margin-bottom: 3px;"
                                               href="javascript:void(0)" data-user="{{ $fan->user_id }}"
