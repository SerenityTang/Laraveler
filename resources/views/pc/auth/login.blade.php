        ...
        <div class="row">
            <div class="auth">
                <form class="form-horizontal bs-example bs-example-form" role="form" method="POST"
                    ...
                    {{--显示操作成功与否提示--}}
                    @if ( session('message') )
                        <div class="alert @if(session('message_type') === 1) alert-success @else alert-danger @endif alert-dismissible login-toptip"
                            ...
                            <p class="message"><i class="fa fa-check-circle fa-lg fa-fw"></i>{{ session('message') }}
                            </p>
                        </div>
                    @endif
                    <strong>用户登录</strong>
                    ...
                    <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   id="username" name="username" placeholder="用户名 / 手机号 / 邮箱"
                    ...
                    <div class="form-group{{ $errors->has('captcha') ? ' has-error' : '' }}"
                        ...
                        <div class="input-group">
                            <span class="input-group-addon c-icon{{ $errors->has('captcha') ? ' c-icon-clear' : '' }}"><i
                                        class="fa fa-check-square fa-fw"></i></span>
                            <input type="text"
                                   class="form-control text c-text{{ $errors->has('captcha') ? ' text-clear' : '' }}"
                                   id="captcha" name="captcha" style="width: 150px" maxlength="4" placeholder="验证码">&nbsp;
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            ...
                            <a href="{{ url('/user/forgot') }}"
                               style="display: inline-block;float: right;padding-right: 7px;"
                               class="forget-pwd">忘记密码？</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="submit-btn">
                            <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat log-btn"
                                    data-loading-text="正在登录..." onautocomplete="off">登 录
                            </button>
                        </div>
                    </div>
