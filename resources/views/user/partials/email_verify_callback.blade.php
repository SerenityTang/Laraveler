...
<html>
    <head>
        ...
        <style>
            ...
            p.tip {font-size: 20px;font-weight: 500;text-align: center;margin-top: 280px;}
            p.return {text-align: center;}
            a.return-btn {width: 500px;height: 50px;text-align: center;text-decoration: none;margin: 5px auto;background-color: #22d7bb;color: #fff;padding: 10px 15px;
